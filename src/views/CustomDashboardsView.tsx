  ...
  return (
    <div className="space-y-6">
      ...
      <PagePlaceholder
        ...
        description="Design bespoke Business Intelligence dashboards using customizable metric cards, time-series graphs, and pie charts. Persist layouts per user or share via public URLs."
        ...
        plannedFeatures={[
          ...
          'Public Workspace Sharing via Shareable Hash Links',
          'PDF & CSV Automated Export Pipeline',
          'Multi-Dashboard Switching & Category Tagging',
        ]}
      />
    </div>
  );
